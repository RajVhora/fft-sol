                          ...
                          int n_alpha, double *alpha)
{
    ...
    for (i1 = 0; i1 < n_x; ++i1)
    {
        for (i2 = 0; i2 < n_y; ++i2)
        {
            ...
            A11 = A11 + (Ceff[1][1][1][1] + DeltaC[1][1][1][1] * a) * epsstr11 + (Ceff[1][1][2][2] + DeltaC[1][1][2][2] * a) * epsstr22 + (Ceff[1][1][1][2] + DeltaC[1][1][1][2] * a) * epsstr12 + (Ceff[1][1][2][1] + DeltaC[1][1][2][1] * a) * epsstr12;
            A22 = A22 + (Ceff[2][2][1][1] + DeltaC[2][2][1][1] * a) * epsstr11 + (Ceff[2][2][2][2] + DeltaC[2][2][2][2] * a) * epsstr22 + (Ceff[2][2][1][2] + DeltaC[2][2][1][2] * a) * epsstr12 + (Ceff[2][2][2][1] + DeltaC[2][2][2][1] * a) * epsstr12;
            A12 = A12 + (Ceff[1][2][1][2] + DeltaC[1][2][1][2] * a + Ceff[1][2][2][1] + DeltaC[1][2][2][1] * a) * epsstr12;
        }
    }
